...
class ModelDesignBanner extends Model {
	...
	public function getBannerBrand() {
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "banner b JOIN " . DB_PREFIX . "banner_image bi ON (b.banner_id = bi.banner_id)  AND b.status = '0' AND bi.language_id = '" . (int)$this->config->get('config_language_id') . "' ORDER BY bi.sort_order ASC");
		return $query->rows;
	}
}
