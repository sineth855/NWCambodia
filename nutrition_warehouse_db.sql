...
--
-- Database: `nutrition_warehouse`
--

-- --------------------------------------------------------

--
-- Table structure for table `nw_address`
--

DROP TABLE IF EXISTS `nw_address`;
CREATE TABLE IF NOT EXISTS `nw_address` (
...
--
-- Table structure for table `nw_api`
--

DROP TABLE IF EXISTS `nw_api`;
CREATE TABLE IF NOT EXISTS `nw_api` (
...
--
-- Dumping data for table `nw_api`
--

INSERT INTO `nw_api` (`api_id`, `username`, `key`, `status`, `date_added`, `date_modified`) VALUES
(1, 'Default', '', 1, '2020-03-08 11:09:15', '2020-03-08 11:09:15');

-- --------------------------------------------------------

--
-- Table structure for table `nw_api_ip`
--

DROP TABLE IF EXISTS `nw_api_ip`;
CREATE TABLE IF NOT EXISTS `nw_api_ip` (
...
--
-- Table structure for table `nw_api_session`
--

DROP TABLE IF EXISTS `nw_api_session`;
CREATE TABLE IF NOT EXISTS `nw_api_session` (
...
--
-- Table structure for table `nw_attribute`
--

DROP TABLE IF EXISTS `nw_attribute`;
CREATE TABLE IF NOT EXISTS `nw_attribute` (
...
--
-- Dumping data for table `nw_attribute`
--

INSERT INTO `nw_attribute` (`attribute_id`, `attribute_group_id`, `sort_order`) VALUES
(1, 6, 1),
(2, 6, 5),
(3, 6, 3),
(4, 3, 1),
...
--
-- Table structure for table `nw_attribute_description`
--

DROP TABLE IF EXISTS `nw_attribute_description`;
CREATE TABLE IF NOT EXISTS `nw_attribute_description` (
...
--
-- Dumping data for table `nw_attribute_description`
--

INSERT INTO `nw_attribute_description` (`attribute_id`, `language_id`, `name`) VALUES
(1, 1, 'Description'),
(2, 1, 'No. of Cores'),
(4, 1, 'test 1'),
(5, 1, 'test 2'),
...
--
-- Table structure for table `nw_attribute_group`
--

DROP TABLE IF EXISTS `nw_attribute_group`;
CREATE TABLE IF NOT EXISTS `nw_attribute_group` (
...
--
-- Dumping data for table `nw_attribute_group`
--

INSERT INTO `nw_attribute_group` (`attribute_group_id`, `sort_order`) VALUES
(3, 2),
(4, 1),
(5, 3),
(6, 4);
...
--
-- Table structure for table `nw_attribute_group_description`
--

DROP TABLE IF EXISTS `nw_attribute_group_description`;
CREATE TABLE IF NOT EXISTS `nw_attribute_group_description` (
  `attribute_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL,
...
--
-- Dumping data for table `nw_attribute_group_description`
--

INSERT INTO `nw_attribute_group_description` (`attribute_group_id`, `language_id`, `name`) VALUES
(3, 1, 'Memory'),
(4, 1, 'Technical'),
(5, 1, 'Motherboard'),
(6, 1, 'Processor');
...
--
-- Table structure for table `nw_banner`
--

DROP TABLE IF EXISTS `nw_banner`;
...
--
-- Table structure for table `nw_banner_image`
--

DROP TABLE IF EXISTS `nw_banner_image`;
CREATE TABLE IF NOT EXISTS `nw_banner_image` (
...
--
-- Table structure for table `nw_cart`
--

DROP TABLE IF EXISTS `nw_cart`;
CREATE TABLE IF NOT EXISTS `nw_cart` (
...
INSERT INTO `nw_category` (`category_id`, `image`, `parent_id`, `top`, `column`, `sort_order`, `status`, `date_added`, `date_modified`) VALUES
...
--
-- Table structure for table `nw_category_description`
--

DROP TABLE IF EXISTS `nw_category_description`;
CREATE TABLE IF NOT EXISTS `nw_category_description` (
...
--
-- Dumping data for table `nw_category_description`
--

INSERT INTO `nw_category_description` (`category_id`, `language_id`, `name`, `description`, `meta_title`, `meta_description`, `meta_keyword`) VALUES
...
--
-- Table structure for table `nw_category_filter`
--

DROP TABLE IF EXISTS `nw_category_filter`;
CREATE TABLE IF NOT EXISTS `nw_category_filter` (
  `category_id` int(11) NOT NULL,
...
--
-- Table structure for table `nw_category_path`
--

DROP TABLE IF EXISTS `nw_category_path`;
CREATE TABLE IF NOT EXISTS `nw_category_path` (
  `category_id` int(11) NOT NULL,
...
--
-- Dumping data for table `nw_category_path`
--

INSERT INTO `nw_category_path` (`category_id`, `path_id`, `level`) VALUES
(25, 25, 0),
(28, 25, 0),
(28, 28, 1),
(35, 25, 0),
...
--
-- Table structure for table `nw_category_to_layout`
--

DROP TABLE IF EXISTS `nw_category_to_layout`;
CREATE TABLE IF NOT EXISTS `nw_category_to_layout` (
  `category_id` int(11) NOT NULL,
...
--
-- Table structure for table `nw_category_to_store`
--

DROP TABLE IF EXISTS `nw_category_to_store`;
CREATE TABLE IF NOT EXISTS `nw_category_to_store` (
  `category_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  PRIMARY KEY (`category_id`,`store_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `nw_category_to_store`
--

INSERT INTO `nw_category_to_store` (`category_id`, `store_id`) VALUES
(17, 0),
(18, 0),
(20, 0),
(24, 0),
...
--
-- Table structure for table `nw_country`
--

DROP TABLE IF EXISTS `nw_country`;
CREATE TABLE IF NOT EXISTS `nw_country` (
...
--
-- Dumping data for table `nw_country`
--

INSERT INTO `nw_country` (`country_id`, `name`, `iso_code_2`, `iso_code_3`, `address_format`, `postcode_required`, `status`) VALUES
...
--
-- Table structure for table `nw_coupon`
--

DROP TABLE IF EXISTS `nw_coupon`;
CREATE TABLE IF NOT EXISTS `nw_coupon` (
...
--
-- Dumping data for table `nw_coupon`
--

INSERT INTO `nw_coupon` (`coupon_id`, `name`, `code`, `type`, `discount`, `logged`, `shipping`, `total`, `date_start`, `date_end`, `uses_total`, `uses_customer`, `status`, `date_added`) VALUES
...
--
-- Table structure for table `nw_coupon_category`
--

DROP TABLE IF EXISTS `nw_coupon_category`;
CREATE TABLE IF NOT EXISTS `nw_coupon_category` (
...
--
-- Table structure for table `nw_coupon_history`
--

DROP TABLE IF EXISTS `nw_coupon_history`;
CREATE TABLE IF NOT EXISTS `nw_coupon_history` (
...
--
-- Table structure for table `nw_coupon_product`
--

DROP TABLE IF EXISTS `nw_coupon_product`;
CREATE TABLE IF NOT EXISTS `nw_coupon_product` (
...
--
-- Table structure for table `nw_currency`
--

DROP TABLE IF EXISTS `nw_currency`;
CREATE TABLE IF NOT EXISTS `nw_currency` (
...
DROP TABLE IF EXISTS `nw_customer`;
...
--
-- Table structure for table `nw_customer_activity`
--

DROP TABLE IF EXISTS `nw_customer_activity`;
CREATE TABLE IF NOT EXISTS `nw_customer_activity` (
...
--
-- Table structure for table `nw_customer_affiliate`
--

DROP TABLE IF EXISTS `nw_customer_affiliate`;
CREATE TABLE IF NOT EXISTS `nw_customer_affiliate` (
  `customer_id` int(11) NOT NULL,
  `company` varchar(40) NOT NULL,
...
--
-- Table structure for table `nw_customer_approval`
--

DROP TABLE IF EXISTS `nw_customer_approval`;
CREATE TABLE IF NOT EXISTS `nw_customer_approval` (
...
--
-- Table structure for table `nw_customer_group`
--

DROP TABLE IF EXISTS `nw_customer_group`;
CREATE TABLE IF NOT EXISTS `nw_customer_group` (
...
--
-- Dumping data for table `nw_customer_group`
--

INSERT INTO `nw_customer_group` (`customer_group_id`, `approval`, `sort_order`) VALUES
(1, 0, 1);

-- --------------------------------------------------------

--
-- Table structure for table `nw_customer_group_description`
--

DROP TABLE IF EXISTS `nw_customer_group_description`;
CREATE TABLE IF NOT EXISTS `nw_customer_group_description` (
  `customer_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
...
--
-- Dumping data for table `nw_customer_group_description`
--

INSERT INTO `nw_customer_group_description` (`customer_group_id`, `language_id`, `name`, `description`) VALUES
(1, 1, 'Default', 'test');

-- --------------------------------------------------------

--
-- Table structure for table `nw_customer_history`
--

DROP TABLE IF EXISTS `nw_customer_history`;
CREATE TABLE IF NOT EXISTS `nw_customer_history` (
...
--
-- Table structure for table `nw_customer_ip`
--

DROP TABLE IF EXISTS `nw_customer_ip`;
CREATE TABLE IF NOT EXISTS `nw_customer_ip` (
...
--
-- Table structure for table `nw_customer_login`
--

DROP TABLE IF EXISTS `nw_customer_login`;
CREATE TABLE IF NOT EXISTS `nw_customer_login` (
...
--
-- Table structure for table `nw_customer_online`
--

DROP TABLE IF EXISTS `nw_customer_online`;
CREATE TABLE IF NOT EXISTS `nw_customer_online` (
  `ip` varchar(40) NOT NULL,
  `customer_id` int(11) NOT NULL,
  `url` text NOT NULL,
...
--
-- Table structure for table `nw_customer_reward`
--

DROP TABLE IF EXISTS `nw_customer_reward`;
CREATE TABLE IF NOT EXISTS `nw_customer_reward` (
...
--
-- Table structure for table `nw_customer_search`
--

DROP TABLE IF EXISTS `nw_customer_search`;
CREATE TABLE IF NOT EXISTS `nw_customer_search` (
...
--
-- Table structure for table `nw_customer_transaction`
--

DROP TABLE IF EXISTS `nw_customer_transaction`;
CREATE TABLE IF NOT EXISTS `nw_customer_transaction` (
...
--
-- Table structure for table `nw_customer_wishlist`
--

DROP TABLE IF EXISTS `nw_customer_wishlist`;
CREATE TABLE IF NOT EXISTS `nw_customer_wishlist` (
  `customer_id` int(11) NOT NULL,
  `product_id` int(11) NOT NULL,
  `date_added` datetime NOT NULL,
...
--
-- Table structure for table `nw_custom_field`
--

DROP TABLE IF EXISTS `nw_custom_field`;
CREATE TABLE IF NOT EXISTS `nw_custom_field` (
...
--
-- Table structure for table `nw_custom_field_customer_group`
--

DROP TABLE IF EXISTS `nw_custom_field_customer_group`;
CREATE TABLE IF NOT EXISTS `nw_custom_field_customer_group` (
...
--
-- Table structure for table `nw_custom_field_description`
--

DROP TABLE IF EXISTS `nw_custom_field_description`;
CREATE TABLE IF NOT EXISTS `nw_custom_field_description` (
  `custom_field_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(128) NOT NULL,
...
--
-- Table structure for table `nw_custom_field_value`
--

DROP TABLE IF EXISTS `nw_custom_field_value`;
CREATE TABLE IF NOT EXISTS `nw_custom_field_value` (
...
--
-- Table structure for table `nw_custom_field_value_description`
--

DROP TABLE IF EXISTS `nw_custom_field_value_description`;
CREATE TABLE IF NOT EXISTS `nw_custom_field_value_description` (
...
--
-- Table structure for table `nw_download`
--

DROP TABLE IF EXISTS `nw_download`;
CREATE TABLE IF NOT EXISTS `nw_download` (
...
--
-- Table structure for table `nw_download_description`
--

DROP TABLE IF EXISTS `nw_download_description`;
CREATE TABLE IF NOT EXISTS `nw_download_description` (
...
--
-- Table structure for table `nw_event`
--

DROP TABLE IF EXISTS `nw_event`;
CREATE TABLE IF NOT EXISTS `nw_event` (
...
INSERT INTO `nw_event` (`event_id`, `code`, `trigger`, `action`, `status`, `sort_order`) VALUES
...
--
-- Table structure for table `nw_extension`
--

DROP TABLE IF EXISTS `nw_extension`;
CREATE TABLE IF NOT EXISTS `nw_extension` (
...
--
-- Table structure for table `nw_extension_install`
--

DROP TABLE IF EXISTS `nw_extension_install`;
CREATE TABLE IF NOT EXISTS `nw_extension_install` (
...
--
-- Table structure for table `nw_extension_path`
--

DROP TABLE IF EXISTS `nw_extension_path`;
CREATE TABLE IF NOT EXISTS `nw_extension_path` (
...
--
-- Table structure for table `nw_filter`
--

DROP TABLE IF EXISTS `nw_filter`;
CREATE TABLE IF NOT EXISTS `nw_filter` (
...
--
-- Table structure for table `nw_filter_description`
--

DROP TABLE IF EXISTS `nw_filter_description`;
CREATE TABLE IF NOT EXISTS `nw_filter_description` (
  `filter_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `filter_group_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL,
...
--
-- Table structure for table `nw_filter_group`
--

DROP TABLE IF EXISTS `nw_filter_group`;
CREATE TABLE IF NOT EXISTS `nw_filter_group` (
...
--
-- Table structure for table `nw_filter_group_description`
--

DROP TABLE IF EXISTS `nw_filter_group_description`;
CREATE TABLE IF NOT EXISTS `nw_filter_group_description` (
  `filter_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL,
...
--
-- Table structure for table `nw_geo_zone`
--

DROP TABLE IF EXISTS `nw_geo_zone`;
CREATE TABLE IF NOT EXISTS `nw_geo_zone` (
...
--
-- Dumping data for table `nw_geo_zone`
--

INSERT INTO `nw_geo_zone` (`geo_zone_id`, `name`, `description`, `date_added`, `date_modified`) VALUES
...
--
-- Table structure for table `nw_googleshopping_category`
--

DROP TABLE IF EXISTS `nw_googleshopping_category`;
CREATE TABLE IF NOT EXISTS `nw_googleshopping_category` (
...
--
-- Table structure for table `nw_googleshopping_product`
--

DROP TABLE IF EXISTS `nw_googleshopping_product`;
CREATE TABLE IF NOT EXISTS `nw_googleshopping_product` (
...
--
-- Table structure for table `nw_googleshopping_product_status`
--

DROP TABLE IF EXISTS `nw_googleshopping_product_status`;
CREATE TABLE IF NOT EXISTS `nw_googleshopping_product_status` (
...
--
-- Table structure for table `nw_googleshopping_product_target`
--

DROP TABLE IF EXISTS `nw_googleshopping_product_target`;
CREATE TABLE IF NOT EXISTS `nw_googleshopping_product_target` (
  `product_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL DEFAULT 0,
...
--
-- Table structure for table `nw_googleshopping_target`
--

DROP TABLE IF EXISTS `nw_googleshopping_target`;
CREATE TABLE IF NOT EXISTS `nw_googleshopping_target` (
  `advertise_google_target_id` int(11) UNSIGNED NOT NULL,
  `store_id` int(11) NOT NULL DEFAULT 0,
...
--
-- Table structure for table `nw_information`
--

DROP TABLE IF EXISTS `nw_information`;
CREATE TABLE IF NOT EXISTS `nw_information` (
...
--
-- Dumping data for table `nw_information`
--

INSERT INTO `nw_information` (`information_id`, `bottom`, `sort_order`, `status`) VALUES
(3, 1, 3, 1),
(4, 1, 1, 1),
(5, 1, 4, 1),
(6, 1, 2, 1);
...
--
-- Table structure for table `nw_information_description`
--

DROP TABLE IF EXISTS `nw_information_description`;
CREATE TABLE IF NOT EXISTS `nw_information_description` (
...
--
-- Dumping data for table `nw_information_description`
--

INSERT INTO `nw_information_description` (`information_id`, `language_id`, `title`, `description`, `meta_title`, `meta_description`, `meta_keyword`) VALUES
(4, 1, 'About Us', '&lt;p&gt;\r\n	About Us&lt;/p&gt;\r\n', 'About Us', '', ''),
...
--
-- Table structure for table `nw_information_to_layout`
--

DROP TABLE IF EXISTS `nw_information_to_layout`;
CREATE TABLE IF NOT EXISTS `nw_information_to_layout` (
  `information_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `layout_id` int(11) NOT NULL,
...
--
-- Table structure for table `nw_information_to_store`
--

DROP TABLE IF EXISTS `nw_information_to_store`;
CREATE TABLE IF NOT EXISTS `nw_information_to_store` (
  `information_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  PRIMARY KEY (`information_id`,`store_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `nw_information_to_store`
--

INSERT INTO `nw_information_to_store` (`information_id`, `store_id`) VALUES
(3, 0),
(4, 0),
(5, 0),
(6, 0);
...
--
-- Table structure for table `nw_language`
--

DROP TABLE IF EXISTS `nw_language`;
CREATE TABLE IF NOT EXISTS `nw_language` (
...
--
-- Table structure for table `nw_layout`
--

DROP TABLE IF EXISTS `nw_layout`;
CREATE TABLE IF NOT EXISTS `nw_layout` (
...
--
-- Dumping data for table `nw_layout`
--

INSERT INTO `nw_layout` (`layout_id`, `name`) VALUES
(1, 'Home'),
(2, 'Product'),
(3, 'Category'),
(4, 'Default'),
...
--
-- Table structure for table `nw_layout_module`
--

DROP TABLE IF EXISTS `nw_layout_module`;
CREATE TABLE IF NOT EXISTS `nw_layout_module` (
...
INSERT INTO `nw_layout_module` (`layout_module_id`, `layout_id`, `code`, `position`, `sort_order`) VALUES
(2, 4, '0', 'content_top', 0),
(3, 4, '0', 'content_top', 1),
...
--
-- Table structure for table `nw_layout_route`
--

DROP TABLE IF EXISTS `nw_layout_route`;
CREATE TABLE IF NOT EXISTS `nw_layout_route` (
...
--
-- Table structure for table `nw_length_class`
--

DROP TABLE IF EXISTS `nw_length_class`;
CREATE TABLE IF NOT EXISTS `nw_length_class` (
...
--
-- Dumping data for table `nw_length_class`
--

INSERT INTO `nw_length_class` (`length_class_id`, `value`) VALUES
(1, '1.00000000'),
(2, '10.00000000'),
(3, '0.39370000');
...
--
-- Table structure for table `nw_length_class_description`
--

DROP TABLE IF EXISTS `nw_length_class_description`;
CREATE TABLE IF NOT EXISTS `nw_length_class_description` (
...
--
-- Dumping data for table `nw_length_class_description`
--

INSERT INTO `nw_length_class_description` (`length_class_id`, `language_id`, `title`, `unit`) VALUES
(1, 1, 'Centimeter', 'cm'),
(2, 1, 'Millimeter', 'mm'),
(3, 1, 'Inch', 'in');
...
CREATE TABLE IF NOT EXISTS `nw_location` (
...
--
-- Table structure for table `nw_manufacturer`
--

DROP TABLE IF EXISTS `nw_manufacturer`;
CREATE TABLE IF NOT EXISTS `nw_manufacturer` (
...
--
-- Dumping data for table `nw_manufacturer`
--

INSERT INTO `nw_manufacturer` (`manufacturer_id`, `name`, `image`, `sort_order`) VALUES
...
--
-- Table structure for table `nw_manufacturer_to_store`
--

DROP TABLE IF EXISTS `nw_manufacturer_to_store`;
CREATE TABLE IF NOT EXISTS `nw_manufacturer_to_store` (
...
--
-- Dumping data for table `nw_manufacturer_to_store`
--

INSERT INTO `nw_manufacturer_to_store` (`manufacturer_id`, `store_id`) VALUES
(5, 0),
(6, 0),
(7, 0),
(8, 0),
...
--
-- Table structure for table `nw_marketing`
--

DROP TABLE IF EXISTS `nw_marketing`;
CREATE TABLE IF NOT EXISTS `nw_marketing` (
...
--
-- Table structure for table `nw_modification`
--

DROP TABLE IF EXISTS `nw_modification`;
CREATE TABLE IF NOT EXISTS `nw_modification` (
...
--
-- Table structure for table `nw_module`
--

DROP TABLE IF EXISTS `nw_module`;
CREATE TABLE IF NOT EXISTS `nw_module` (
...
INSERT INTO `nw_module` (`module_id`, `name`, `code`, `setting`) VALUES
...
--
-- Table structure for table `nw_option`
--

DROP TABLE IF EXISTS `nw_option`;
CREATE TABLE IF NOT EXISTS `nw_option` (
...
INSERT INTO `nw_option` (`option_id`, `type`, `sort_order`) VALUES
(1, 'radio', 1),
(2, 'checkbox', 2),
(4, 'text', 3),
(5, 'select', 4),
...
--
-- Table structure for table `nw_option_description`
--

DROP TABLE IF EXISTS `nw_option_description`;
CREATE TABLE IF NOT EXISTS `nw_option_description` (
...
--
-- Dumping data for table `nw_option_description`
--

INSERT INTO `nw_option_description` (`option_id`, `language_id`, `name`) VALUES
(1, 1, 'Radio'),
(2, 1, 'Checkbox'),
(4, 1, 'Text'),
(6, 1, 'Textarea'),
...
--
-- Table structure for table `nw_option_value`
--

DROP TABLE IF EXISTS `nw_option_value`;
CREATE TABLE IF NOT EXISTS `nw_option_value` (
...
INSERT INTO `nw_option_value` (`option_value_id`, `option_id`, `image`, `sort_order`) VALUES
(43, 1, '', 3),
(32, 1, '', 1),
(45, 2, '', 4),
(44, 2, '', 3),
...
--
-- Table structure for table `nw_option_value_description`
--

DROP TABLE IF EXISTS `nw_option_value_description`;
CREATE TABLE IF NOT EXISTS `nw_option_value_description` (
...
--
-- Dumping data for table `nw_option_value_description`
--

INSERT INTO `nw_option_value_description` (`option_value_id`, `language_id`, `option_id`, `name`) VALUES
(43, 1, 1, 'Large'),
(32, 1, 1, 'Small'),
(45, 1, 2, 'Checkbox 4'),
(44, 1, 2, 'Checkbox 3'),
...
--
-- Table structure for table `nw_order`
--

DROP TABLE IF EXISTS `nw_order`;
CREATE TABLE IF NOT EXISTS `nw_order` (
...
--
-- Table structure for table `nw_order_history`
--

DROP TABLE IF EXISTS `nw_order_history`;
CREATE TABLE IF NOT EXISTS `nw_order_history` (
...
--
-- Table structure for table `nw_order_option`
--

DROP TABLE IF EXISTS `nw_order_option`;
CREATE TABLE IF NOT EXISTS `nw_order_option` (
...
--
-- Table structure for table `nw_order_product`
--

DROP TABLE IF EXISTS `nw_order_product`;
CREATE TABLE IF NOT EXISTS `nw_order_product` (
...
--
-- Table structure for table `nw_order_recurring`
--

DROP TABLE IF EXISTS `nw_order_recurring`;
CREATE TABLE IF NOT EXISTS `nw_order_recurring` (
...
--
-- Table structure for table `nw_order_recurring_transaction`
--

DROP TABLE IF EXISTS `nw_order_recurring_transaction`;
CREATE TABLE IF NOT EXISTS `nw_order_recurring_transaction` (
...
--
-- Table structure for table `nw_order_shipment`
--

DROP TABLE IF EXISTS `nw_order_shipment`;
CREATE TABLE IF NOT EXISTS `nw_order_shipment` (
...
--
-- Table structure for table `nw_order_status`
--

DROP TABLE IF EXISTS `nw_order_status`;
CREATE TABLE IF NOT EXISTS `nw_order_status` (
...
--
-- Dumping data for table `nw_order_status`
--

INSERT INTO `nw_order_status` (`order_status_id`, `language_id`, `name`) VALUES
(2, 1, 'Processing'),
(3, 1, 'Shipped'),
(7, 1, 'Canceled'),
(5, 1, 'Complete'),
...
--
-- Table structure for table `nw_order_total`
--

DROP TABLE IF EXISTS `nw_order_total`;
CREATE TABLE IF NOT EXISTS `nw_order_total` (
...
--
-- Table structure for table `nw_order_voucher`
--

DROP TABLE IF EXISTS `nw_order_voucher`;
CREATE TABLE IF NOT EXISTS `nw_order_voucher` (
...
--
-- Table structure for table `nw_product`
--

DROP TABLE IF EXISTS `nw_product`;
CREATE TABLE IF NOT EXISTS `nw_product` (
...
--
-- Dumping data for table `nw_product`
--
...
--
-- Table structure for table `nw_product_attribute`
--

DROP TABLE IF EXISTS `nw_product_attribute`;
CREATE TABLE IF NOT EXISTS `nw_product_attribute` (
  `product_id` int(11) NOT NULL,
  `attribute_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `text` text NOT NULL,
...
--
-- Dumping data for table `nw_product_attribute`
--
...
--
-- Table structure for table `nw_product_description`
--

DROP TABLE IF EXISTS `nw_product_description`;
CREATE TABLE IF NOT EXISTS `nw_product_description` (
  `product_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
  `description` text NOT NULL,
...
--
-- Dumping data for table `nw_product_description`
--

INSERT INTO `nw_product_description` (`product_id`, `language_id`, `name`, `description`, `tag`, `meta_title`, `meta_description`, `meta_keyword`) VALUES
(35, 1, 'Product 8', '&lt;p&gt;\r\n	Product 8&lt;/p&gt;\r\n', '', 'Product 8', '', ''),
...
--
-- Table structure for table `nw_product_discount`
--

DROP TABLE IF EXISTS `nw_product_discount`;
CREATE TABLE IF NOT EXISTS `nw_product_discount` (
...
--
-- Dumping data for table `nw_product_discount`
--

INSERT INTO `nw_product_discount` (`product_discount_id`, `product_id`, `customer_group_id`, `quantity`, `priority`, `price`, `date_start`, `date_end`) VALUES
...
--
-- Table structure for table `nw_product_filter`
--

DROP TABLE IF EXISTS `nw_product_filter`;
CREATE TABLE IF NOT EXISTS `nw_product_filter` (
  `product_id` int(11) NOT NULL,
  `filter_id` int(11) NOT NULL,
...
--
-- Table structure for table `nw_product_image`
--

DROP TABLE IF EXISTS `nw_product_image`;
CREATE TABLE IF NOT EXISTS `nw_product_image` (
...
INSERT INTO `nw_product_image` (`product_image_id`, `product_id`, `image`, `sort_order`) VALUES
...
--
-- Table structure for table `nw_product_option`
--

DROP TABLE IF EXISTS `nw_product_option`;
CREATE TABLE IF NOT EXISTS `nw_product_option` (
...
INSERT INTO `nw_product_option` (`product_option_id`, `product_id`, `option_id`, `value`, `required`) VALUES
(224, 35, 11, '', 1),
...
--
-- Table structure for table `nw_product_option_value`
--

DROP TABLE IF EXISTS `nw_product_option_value`;
CREATE TABLE IF NOT EXISTS `nw_product_option_value` (
...
--
-- Table structure for table `nw_product_recurring`
--

DROP TABLE IF EXISTS `nw_product_recurring`;
CREATE TABLE IF NOT EXISTS `nw_product_recurring` (
  `product_id` int(11) NOT NULL,
  `recurring_id` int(11) NOT NULL,
  `customer_group_id` int(11) NOT NULL,
...
--
-- Table structure for table `nw_product_related`
--

DROP TABLE IF EXISTS `nw_product_related`;
CREATE TABLE IF NOT EXISTS `nw_product_related` (
  `product_id` int(11) NOT NULL,
...
--
-- Dumping data for table `nw_product_related`
--

INSERT INTO `nw_product_related` (`product_id`, `related_id`) VALUES
(40, 42),
(41, 42),
(42, 40),
(42, 41);
...
--
-- Table structure for table `nw_product_reward`
--

DROP TABLE IF EXISTS `nw_product_reward`;
CREATE TABLE IF NOT EXISTS `nw_product_reward` (
...
INSERT INTO `nw_product_reward` (`product_reward_id`, `product_id`, `customer_group_id`, `points`) VALUES
(515, 42, 1, 100),
(519, 47, 1, 300),
(379, 28, 1, 400),
(329, 43, 1, 600),
...
--
-- Table structure for table `nw_product_special`
--

DROP TABLE IF EXISTS `nw_product_special`;
CREATE TABLE IF NOT EXISTS `nw_product_special` (
...
--
-- Dumping data for table `nw_product_special`
--

INSERT INTO `nw_product_special` (`product_special_id`, `product_id`, `customer_group_id`, `priority`, `price`, `date_start`, `date_end`) VALUES
...
--
-- Table structure for table `nw_product_to_category`
--

DROP TABLE IF EXISTS `nw_product_to_category`;
CREATE TABLE IF NOT EXISTS `nw_product_to_category` (
  `product_id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL,
...
--
-- Dumping data for table `nw_product_to_category`
--

INSERT INTO `nw_product_to_category` (`product_id`, `category_id`) VALUES
(28, 20),
(28, 24),
(29, 20),
(29, 24),
...
--
-- Table structure for table `nw_product_to_download`
--

DROP TABLE IF EXISTS `nw_product_to_download`;
CREATE TABLE IF NOT EXISTS `nw_product_to_download` (
  `product_id` int(11) NOT NULL,
  `download_id` int(11) NOT NULL,
...
--
-- Table structure for table `nw_product_to_layout`
--

DROP TABLE IF EXISTS `nw_product_to_layout`;
CREATE TABLE IF NOT EXISTS `nw_product_to_layout` (
  `product_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `layout_id` int(11) NOT NULL,
...
--
-- Table structure for table `nw_product_to_store`
--

DROP TABLE IF EXISTS `nw_product_to_store`;
CREATE TABLE IF NOT EXISTS `nw_product_to_store` (
  `product_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL DEFAULT 0,
  PRIMARY KEY (`product_id`,`store_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `nw_product_to_store`
--

INSERT INTO `nw_product_to_store` (`product_id`, `store_id`) VALUES
(28, 0),
(29, 0),
(30, 0),
(31, 0),
...
--
-- Table structure for table `nw_recurring`
--

DROP TABLE IF EXISTS `nw_recurring`;
CREATE TABLE IF NOT EXISTS `nw_recurring` (
...
--
-- Table structure for table `nw_recurring_description`
--

DROP TABLE IF EXISTS `nw_recurring_description`;
CREATE TABLE IF NOT EXISTS `nw_recurring_description` (
  `recurring_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
...
--
-- Table structure for table `nw_return`
--

DROP TABLE IF EXISTS `nw_return`;
CREATE TABLE IF NOT EXISTS `nw_return` (
...
--
-- Table structure for table `nw_return_action`
--

DROP TABLE IF EXISTS `nw_return_action`;
CREATE TABLE IF NOT EXISTS `nw_return_action` (
...
--
-- Dumping data for table `nw_return_action`
--

INSERT INTO `nw_return_action` (`return_action_id`, `language_id`, `name`) VALUES
(1, 1, 'Refunded'),
(2, 1, 'Credit Issued'),
...
--
-- Table structure for table `nw_return_history`
--

DROP TABLE IF EXISTS `nw_return_history`;
CREATE TABLE IF NOT EXISTS `nw_return_history` (
...
--
-- Table structure for table `nw_return_reason`
--

DROP TABLE IF EXISTS `nw_return_reason`;
CREATE TABLE IF NOT EXISTS `nw_return_reason` (
...
--
-- Dumping data for table `nw_return_reason`
--

INSERT INTO `nw_return_reason` (`return_reason_id`, `language_id`, `name`) VALUES
(1, 1, 'Dead On Arrival'),
...
--
-- Table structure for table `nw_return_status`
--

DROP TABLE IF EXISTS `nw_return_status`;
CREATE TABLE IF NOT EXISTS `nw_return_status` (
...
--
-- Dumping data for table `nw_return_status`
--

INSERT INTO `nw_return_status` (`return_status_id`, `language_id`, `name`) VALUES
(1, 1, 'Pending'),
(3, 1, 'Complete'),
...
--
-- Table structure for table `nw_review`
--

DROP TABLE IF EXISTS `nw_review`;
...
--
-- Table structure for table `nw_seo_url`
--

DROP TABLE IF EXISTS `nw_seo_url`;
CREATE TABLE IF NOT EXISTS `nw_seo_url` (
...
INSERT INTO `nw_seo_url` (`seo_url_id`, `store_id`, `language_id`, `query`, `keyword`) VALUES
...
--
-- Table structure for table `nw_session`
--

DROP TABLE IF EXISTS `nw_session`;
CREATE TABLE IF NOT EXISTS `nw_session` (
  `session_id` varchar(32) NOT NULL,
  `data` text NOT NULL,
...
--
-- Dumping data for table `nw_session`
--
...
--
-- Table structure for table `nw_setting`
--

DROP TABLE IF EXISTS `nw_setting`;
CREATE TABLE IF NOT EXISTS `nw_setting` (
...
--
-- Table structure for table `nw_shipping_courier`
--

DROP TABLE IF EXISTS `nw_shipping_courier`;
CREATE TABLE IF NOT EXISTS `nw_shipping_courier` (
...
--
-- Dumping data for table `nw_shipping_courier`
--

INSERT INTO `nw_shipping_courier` (`shipping_courier_id`, `shipping_courier_code`, `shipping_courier_name`) VALUES
(1, 'dhl', 'DHL'),
(2, 'fedex', 'Fedex'),
(3, 'ups', 'UPS'),
...
--
-- Table structure for table `nw_statistics`
--

DROP TABLE IF EXISTS `nw_statistics`;
CREATE TABLE IF NOT EXISTS `nw_statistics` (
...
--
-- Dumping data for table `nw_statistics`
--
...
--
-- Table structure for table `nw_stock_status`
--

DROP TABLE IF EXISTS `nw_stock_status`;
CREATE TABLE IF NOT EXISTS `nw_stock_status` (
...
--
-- Dumping data for table `nw_stock_status`
--

INSERT INTO `nw_stock_status` (`stock_status_id`, `language_id`, `name`) VALUES
(7, 1, 'In Stock'),
(8, 1, 'Pre-Order'),
(5, 1, 'Out Of Stock'),
(6, 1, '2-3 Days');
...
CREATE TABLE IF NOT EXISTS `nw_store` (
...
--
-- Table structure for table `nw_tax_class`
--

DROP TABLE IF EXISTS `nw_tax_class`;
CREATE TABLE IF NOT EXISTS `nw_tax_class` (
...
--
-- Dumping data for table `nw_tax_class`
--

INSERT INTO `nw_tax_class` (`tax_class_id`, `title`, `description`, `date_added`, `date_modified`) VALUES
...
--
-- Table structure for table `nw_tax_rate`
--

DROP TABLE IF EXISTS `nw_tax_rate`;
CREATE TABLE IF NOT EXISTS `nw_tax_rate` (
...
--
-- Dumping data for table `nw_tax_rate`
--

INSERT INTO `nw_tax_rate` (`tax_rate_id`, `geo_zone_id`, `name`, `rate`, `type`, `date_added`, `date_modified`) VALUES
...
--
-- Table structure for table `nw_tax_rate_to_customer_group`
--

DROP TABLE IF EXISTS `nw_tax_rate_to_customer_group`;
CREATE TABLE IF NOT EXISTS `nw_tax_rate_to_customer_group` (
...
--
-- Dumping data for table `nw_tax_rate_to_customer_group`
--

INSERT INTO `nw_tax_rate_to_customer_group` (`tax_rate_id`, `customer_group_id`) VALUES
(86, 1),
(87, 1);
...
--
-- Table structure for table `nw_tax_rule`
--

DROP TABLE IF EXISTS `nw_tax_rule`;
CREATE TABLE IF NOT EXISTS `nw_tax_rule` (
...
--
-- Dumping data for table `nw_tax_rule`
--

INSERT INTO `nw_tax_rule` (`tax_rule_id`, `tax_class_id`, `tax_rate_id`, `based`, `priority`) VALUES
(121, 10, 86, 'payment', 1),
(120, 10, 87, 'store', 0),
(128, 9, 86, 'shipping', 1),
(127, 9, 87, 'shipping', 2);
...
--
-- Table structure for table `nw_theme`
--

DROP TABLE IF EXISTS `nw_theme`;
CREATE TABLE IF NOT EXISTS `nw_theme` (
...
--
-- Table structure for table `nw_translation`
--

DROP TABLE IF EXISTS `nw_translation`;
CREATE TABLE IF NOT EXISTS `nw_translation` (
...
--
-- Table structure for table `nw_upload`
--

DROP TABLE IF EXISTS `nw_upload`;
CREATE TABLE IF NOT EXISTS `nw_upload` (
...
INSERT INTO `nw_user` (`user_id`, `user_group_id`, `username`, `password`, `salt`, `firstname`, `lastname`, `email`, `image`, `code`, `ip`, `status`, `date_added`) VALUES
(1, 1, 'admin', '86c55c5b0eb79793dc837cd7413e93aa4edf4deb', 'kZPfm2Q2M', 'John', 'Doe', 'test@gmail.com', '', '', '127.0.0.1', 1, '2020-03-08 11:09:15');

-- --------------------------------------------------------

--
-- Table structure for table `nw_user_group`
--

DROP TABLE IF EXISTS `nw_user_group`;
CREATE TABLE IF NOT EXISTS `nw_user_group` (
...
--
-- Dumping data for table `nw_user_group`
--
...
--
-- Table structure for table `nw_voucher`
--

DROP TABLE IF EXISTS `nw_voucher`;
CREATE TABLE IF NOT EXISTS `nw_voucher` (
...
--
-- Table structure for table `nw_voucher_history`
--

DROP TABLE IF EXISTS `nw_voucher_history`;
CREATE TABLE IF NOT EXISTS `nw_voucher_history` (
...
--
-- Table structure for table `nw_voucher_theme`
--

DROP TABLE IF EXISTS `nw_voucher_theme`;
CREATE TABLE IF NOT EXISTS `nw_voucher_theme` (
...
--
-- Dumping data for table `nw_voucher_theme`
--

INSERT INTO `nw_voucher_theme` (`voucher_theme_id`, `image`) VALUES
...
--
-- Table structure for table `nw_voucher_theme_description`
--

DROP TABLE IF EXISTS `nw_voucher_theme_description`;
CREATE TABLE IF NOT EXISTS `nw_voucher_theme_description` (
  `voucher_theme_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(32) NOT NULL,
...
--
-- Dumping data for table `nw_voucher_theme_description`
--

INSERT INTO `nw_voucher_theme_description` (`voucher_theme_id`, `language_id`, `name`) VALUES
(6, 1, 'Christmas'),
(7, 1, 'Birthday'),
(8, 1, 'General');
...
--
-- Table structure for table `nw_weight_class`
--

DROP TABLE IF EXISTS `nw_weight_class`;
CREATE TABLE IF NOT EXISTS `nw_weight_class` (
...
--
-- Dumping data for table `nw_weight_class`
--

INSERT INTO `nw_weight_class` (`weight_class_id`, `value`) VALUES
(1, '1.00000000'),
(2, '1000.00000000'),
(5, '2.20460000'),
(6, '35.27400000');
...
--
-- Table structure for table `nw_weight_class_description`
--

DROP TABLE IF EXISTS `nw_weight_class_description`;
CREATE TABLE IF NOT EXISTS `nw_weight_class_description` (
...
--
-- Dumping data for table `nw_weight_class_description`
--

INSERT INTO `nw_weight_class_description` (`weight_class_id`, `language_id`, `title`, `unit`) VALUES
(1, 1, 'Kilogram', 'kg'),
(2, 1, 'Gram', 'g'),
(5, 1, 'Pound ', 'lb'),
(6, 1, 'Ounce', 'oz');
...
--
-- Table structure for table `nw_zone`
--

DROP TABLE IF EXISTS `nw_zone`;
CREATE TABLE IF NOT EXISTS `nw_zone` (
...
--
-- Dumping data for table `nw_zone`
--

INSERT INTO `nw_zone` (`zone_id`, `country_id`, `name`, `code`, `status`) VALUES
...
--
-- Table structure for table `nw_zone_to_geo_zone`
--

DROP TABLE IF EXISTS `nw_zone_to_geo_zone`;
CREATE TABLE IF NOT EXISTS `nw_zone_to_geo_zone` (
...
--
-- Dumping data for table `nw_zone_to_geo_zone`
--

INSERT INTO `nw_zone_to_geo_zone` (`zone_to_geo_zone_id`, `country_id`, `zone_id`, `geo_zone_id`, `date_added`, `date_modified`) VALUES
