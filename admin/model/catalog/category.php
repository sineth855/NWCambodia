...
class ModelCatalogCategory extends Model {
	...
	public function addCategoryJson($data) {
		$this->db->query("DELETE from " . DB_PREFIX . "category WHERE category_id=".(int)$data['id']."");
		$this->db->query("DELETE from " . DB_PREFIX . "category_path WHERE category_id=".(int)$data['id']."");
		$this->db->query("DELETE from " . DB_PREFIX . "category_to_store WHERE category_id=".(int)$data['id']."");
		$this->db->query("DELETE from " . DB_PREFIX . "category_description WHERE category_id=".(int)$data['id']." AND language_id=".(int)$data["language_id"]."");
		...
		// foreach ($data['category_description'] as $language_id => $value) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "category_description SET category_id = '" . (int)$data["id"] . "', language_id = '" . (int)$data["language_id"] . "', name = '" . $this->db->escape($data['name']) . "', description = '" . $this->db->escape($data['description']) . "', meta_title = '" . $this->db->escape($data['meta_title']) . "', meta_description = '" . $this->db->escape($data['meta_description']) . "', meta_keyword = '" . $this->db->escape($data['meta_keyword']) . "'");
		// }
